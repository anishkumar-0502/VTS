  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Associated Operators', style: TextStyle(color: Colors.white)),
        leading: IconButton(
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoRow('Company', operator.companyName),
                      _buildInfoRow('Address', operator.address),
                      _buildInfoRow('City', operator.city),
                      _buildInfoRow('Status', operator.status ? 'Active' : 'Inactive'),
                      _buildInfoRow('Total Vehicles', operator.totalVehicles.toString()),
                      _buildInfoRow('Total Drivers', operator.totalDrivers.toString()),
                    ],
                  ),
                );
              },
